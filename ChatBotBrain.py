...
def run_conversation(prompt):
    ...
    messages = [
        {"role": "system", "content": "You are a helpfull AI assistant. Only use the functions provided to you and before answer think about the need to seach on internet using the function"},
